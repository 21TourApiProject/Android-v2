...
public class RecyclerMapHashTagAdapter extends RecyclerView.Adapter<RecyclerMapHashTagAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.map__hashtags_full, parent, false);
