 ...
 */
public class MyPostSearchParams {
    ...
    public MyPostSearchParams(Long postId, String thumbnail, String title, String nickName, String profileImage, List<String> hashTagNames) {
        this.postId = postId;
